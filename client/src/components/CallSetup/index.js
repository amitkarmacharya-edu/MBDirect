import { CLOSE_MEETING, LOADING, SET_USER_ID, SHOW_ALERTS, UPDATE_STAGE, INCOMING_CALL } from "../../utils/globalState/webrtc/actions";
                ...
                <div className="col-12 controls text-center">
                    ...
                    {/* toggle video*/}
                    {
                        state.meetingType === "video"
                            ? <button type="button" className="btn btn-secondary bg-white w-25 mx-1" onClick={() => handleVideoAudioToggle("video")}>
                                {
                            ...
                            :
                            < button type="button" className="btn btn-secondary bg-white mx-1 w-25" onClick={() => handleVideoAudioToggle("audio")}>
                                {
